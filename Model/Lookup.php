...
class Lookup
{
    ...
    public function typify($resourceType = null)
    {
        ...
        if (strpos($this->lookup, '\\')) {
            $this->lookupType = self::LT_NAME;
            $this->resourceType = self::RT_CLASS;
        ...
        if (strpos($this->lookup, ':')) {
            $this->lookupType = self::LT_NAME;
            $this->resourceType = self::RT_TEMPLATE;
        ...
        if (strpos($this->lookup, '.')) {
            $this->lookupType = self::LT_NAME;
            $this->resourceType = self::RT_SERVICE;
    ...
    public function getPath()
    {
        ...
        if ($this->lookupType == self::LT_NAME) {
            if ($this->resourceType == self::RT_TEMPLATE) {
